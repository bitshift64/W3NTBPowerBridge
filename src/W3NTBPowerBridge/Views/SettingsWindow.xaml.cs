...
public partial class SettingsWindow : Window
{
    ...
    public SettingsWindow(AppSettings settings)
    {
        Settings = new AppSettings
        {
            ...
            WfviewServerLaunchCommand = settings.WfviewServerLaunchCommand,
            WfviewServerLaunchArguments = settings.WfviewServerLaunchArguments,
            ...
            LaunchWfviewServerDuringStartStation = settings.LaunchWfviewServerDuringStartStation,
